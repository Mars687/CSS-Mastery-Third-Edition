...
要充分享受这本书，你至少应该对CSS如何工作有一点了解，也许你已经和CSS打过一段时间交道，甚至在一两个网站上工作过。这本书开始的三个简短的介绍章节是创建和设计网页的基础，所以即使你生锈了，你会得到一个总结，每一章介绍了语言的新特性和更复杂的例子。即使你是一位经验丰富的CSS的从业者，你应该找到有趣有用的技术解决常见的Web设计的问题很多，在这种情况下，你应该随时跳到你感兴趣的章节。
